...
//                 color: PdfColor.fromInt(0xffdbe3e7),
//                 child: pw.Row(
...
//                 color: PdfColor.fromInt(0xffe9eef1),
//                 child: pw.Row(
...
//                       pw.Spacer(),
//                       pw.Text(
//                         isGiven ? "↑ Rs ${t['amount']}" : "↓ Rs ${t['amount']}",
//                         style: pw.TextStyle(
//                           color: isGiven ? PdfColors.red : PdfColors.green,
//                           fontWeight: pw.FontWeight.bold,
//                         ),
//                       ),
//                     ],
...
//                 child: pw.Center(child: pw.Text("Generated by SmartBahi")),
//               ),
//             ],
//           );
//         },
...
//       appBar: AppBar(title: const Text("Customer Statement"), elevation: 0),
...
//             children: [
//               _chip("Overall", true),
//               _chip("Date Range ▼", false),
//               _chip("This Month", false),
//               _chip("Last 7 days", false),
//             ],
//           ),
...
//           const Text("Balance | 20 - 25 Feb, 2026"),
...
//                         provider.storeName,
//                         provider.storeMobile,
//                         provider.getCustomer(customerName).name,
//                         provider.getCustomer(customerName).mobile,
//                         transactions,
//                         balance,
//                         payment,
//                         credit,
...
//                 pw.Center(child: pw.Text("Balance | Statement Period")),
...
//                   child: pw.Row(
//                     children: [
//                       pw.SizedBox(width: 70, child: pw.Text("Date")),
//                       pw.Expanded(
//                         child: pw.Center(
//                           child: pw.Text(
//                             "Payment (Rs $payment)",
